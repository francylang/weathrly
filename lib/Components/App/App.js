...
export default class App extends React.Component {
  ...
  getData(location) {
    ...
    fetch(`    http://api.wunderground.com/api/a6154ae36fc409e3/forecast/geolookup/conditions/hourly/forecast10day/q/${location}..json
`)
      ...
      .then(weather => this.setState(
        ...
        tenDayForecast: weather.forecast.simpleforecast.forecastday.map(day => day.date.weekday_short)
       }
      })
     )
