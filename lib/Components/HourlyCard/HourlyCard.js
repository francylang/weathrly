...
const HourlyCard = props => {
  return (
    <div className="hourlyCardContainer" key={props.hourlyKey}>
      ...
      <div className="conditionCtnr">
        <h2 className="nameCondition">{props.hourCondition}</h2>
      </div>

      <div className="iconsCtnr">
        <i className={`wi wi-wu-${props.hourIcon} hourlyweatherIcons`}></i>
      </div>
