...
let tempf = data.current_observation.temp_f;
console.log(tempf);

let highf = data.forecast.simpleforecast.forecastday[0].high.fahrenheit;
let lowf = data.forecast.simpleforecast.forecastday[0].low.fahrenheit;
console.log(highf);
console.log(lowf);
