...
let fullCast = data.current_observation.display_location.full;
let time = data.current_observation.local_time_rfc822;
let day = data.forecast.txt_forecast.forecastday[0].title;
let timeAndDate = data.forecast.simpleforecast.forecastday[0].date.pretty;
let currentConditions = data.forecast.simpleforecast.forecastday[0].conditions;
let currentTempf = data.current_observation.temp_f;
let dayHigh = data.forecast.simpleforecast.forecastday[0].high.fahrenheit;
let dayLow = data.forecast.simpleforecast.forecastday[0].low.fahrenheit;
let dailyDescrip = data.forecast.simpleforecast.forecastday[0].fcttext
